    ...
    <main className="mx-auto max-w-5xl px-4 py-8 text-slate-900 dark:text-slate-100">
      <Card className="border-sky-200/80 bg-white/95 dark:border-sky-900/50 dark:bg-slate-900/70">
        <CardHeader>
          ...
          <CardDescription>ひらがなのローマ字入力を練習するタイピングゲーム</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          ...
          {gameState === 'playing' && currentProblem && (
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardDescription>お題（かな）</CardDescription>
                  <CardTitle className="text-4xl font-mono leading-tight">{currentProblem.question}</CardTitle>
                </CardHeader>
                <CardContent>
